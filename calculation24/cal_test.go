...
func TestCalculation(t *testing.T) {
	assert.Equal(t, float32(2.01)+float32(2.0), Calculation(2.01, 2.0, Add))
	assert.Equal(t, float32(2.03)-float32(2.0), Calculation(2.03, 2.0, Subtract))
	assert.Equal(t, float32(2.027)*float32(2.0), Calculation(2.027, 2.0, Multiply))
	assert.Equal(t, float32(2.07)/float32(2.0), Calculation(2.07, 2.0, Divide))
}
